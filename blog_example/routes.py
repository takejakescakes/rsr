...
from blog_example import app, db, bc, mail
from blog_example.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def send_reset_email(user):
	...
	msg = Message(
		...
		sender='takejakescake@gmail.com',
