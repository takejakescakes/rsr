...
from blog_example import db, bc
from blog_example.models import User, Post
from blog_example.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                   RequestResetForm, ResetPasswordForm)
from blog_example.users.utils import save_picture, send_reset_email

u = Blueprint('users', __name__)
...
@u.route('/account', methods=['GET', 'POST'])
@login_required
def account():
...
@u.route("/reset_password", methods=['GET', 'POST'])
def reset_request():
	if current_user.is_authenticated:
		return redirect(url_for('main.home'))
...
@u.route("/reset_password/<token>", methods=['GET', 'POST'])
